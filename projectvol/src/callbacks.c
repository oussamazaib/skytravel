...
f1=fopen("/home/oussama/Downloads/projectvol/uservol.txt","a+");
...
idtemp=fopen ("/home/oussama/Downloads/projectvol/idtemp.txt","a+");
uservol=fopen ("/home/oussama/Downloads/projectvol/uservol.txt","a+");
char pVille_depart[20], pVille_arrivee[20], pJour[20], pMois[20], pAnnee[20], pDuree_vol[20], pClasse[20], pNbre_voyageurs[20], pPrix_vol[20], pId_vol[20];
...
fclose(ftempvol);
fclose(uservol);
remove ("/home/oussama/Downloads/projectvol/idtemp.txt");
remove ("/home/oussama/Downloads/projectvol/uservol.txt");
rename ("/home/oussama/Downloads/projectvol/tempvol.txt","/home/oussama/Downloads/projectvol/uservol.txt");
...
hotel=fopen("/home/oussama/Downloads/projectvol/hotel.txt","a+");
...
GtkWidget *input160, *output160;
       ...
       f3=fopen("/home/oussama/Downloads/projectvol/hotel.txt","r");
...
fhotel=fopen ("/home/oussama/Downloads/projectvol/hotel.txt","a+");
f2=fopen("/home/oussama/Downloads/projectvol/userhotel.txt","a+");
char ville[20], hotel[20], jour[20], mois[20], annee[20], gamme[20], id_hotel[20], tarif[20];
...
fclose(fhotel);
fclose(f2);
remove ("/home/oussama/Downloads/projectvol/userhotel.txt");
rename ("/home/oussama/Downloads/projectvol/hotel.txt","/home/oussama/Downloads/projectvol/userhotel.txt");
